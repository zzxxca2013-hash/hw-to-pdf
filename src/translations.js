...
for (const [lang, t] of Object.entries(translations)) {
  Object.assign(t, compatibilityLabels[lang], {
    ...
    addMore: t.upload.addMore,
    dragPdfHere: t.upload.dragPdf,
    dragPdfFilesHere: t.upload.dragPdf,
    selectFile: t.upload.selectFile,
    clearAll: t.actions.clearAll,
    takePhoto: t.actions.takePhoto,
    removeFile: t.actions.removeFile,
    splitNow: t.actions.splitNow,
    downloadZip: t.actions.downloadZip,
    convertToPdf: t.actions.convert,
    shareNotSupported: t.messages.shareNotSupported,
    errorProcessing: t.messages.errorProcessing,
    errorMaxPages: t.messages.errorMaxPages,
    errorSplit: t.messages.errorSplit,
    processingImage: t.messages.processingImage,
    splitSuccess: t.messages.splitSuccess,
    settingsTitle: t.settings.title,
    addPageNumbers: t.settings.pageNumbers,
    addMargins: t.settings.margins,
    pdfQuality: t.settings.quality,
    qualityHigh: t.settings.high,
    qualityMedium: t.settings.medium,
    qualityLow: t.settings.low,
    fileNameLabel: t.settings.fileNameLabel,
    fileNamePlaceholder: t.settings.fileNamePlaceholder,
    watermarkLabel: t.settings.watermarkLabel,
    watermarkPlaceholder: t.settings.watermarkPlaceholder,
    cropImage: t.editor.crop,
    rotateImage: t.editor.rotate,
    applyCrop: t.editor.applyCrop,
    imageCount: t.ui.imageCount,
    mergeTitle: t.tools.merge.title,
    mergeSubtitle: t.tools.merge.subtitle,
    splitPdfPages: t.tools.split.pages,
    splitPdfDesc: t.tools.split.desc,
    pdf2imgTitle: t.tools.pdf2img.title,
    pdf2imgSubtitle: t.tools.pdf2img.subtitle,
    organizeTitle: t.tools.organize.title,
    organizeSubtitle: t.tools.organize.subtitle,
    compressTitle: t.tools.compress.title,
