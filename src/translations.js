export const translations = {
  en: {
    ...
    mergeSubtitle: "Combine multiple PDFs into a single file securely",
    splitTitle: "Split PDF Files",
    splitSubtitle: "Extract pages from your PDF quickly and offline",
    pdf2imgTitle: "PDF to Images",
    pdf2imgSubtitle: "Convert PDF pages to high-quality JPG images offline",
    organizeTitle: "Organize PDF Pages",
    organizeSubtitle: "Reorder and delete PDF pages easily",
    compressTitle: "Compress PDF",
    compressSubtitle: "Reduce PDF file size for easy sharing",
    ...
    contactEmail: "zzxxca2047@gmail.com",
    ...
    mergeSeoTitle: "Free PDF Merger Tool",
    mergeSeoText: "Easily combine multiple PDF files into one single document. Our free PDF merger tool runs entirely offline in your browser, guaranteeing absolute privacy.",
    mergeFaq: [
    ...
    splitSeoTitle: "Split PDF Files Instantly",
    splitSeoText: "Extract specific pages or separate a large PDF document into smaller pieces. A secure, fast, and local PDF splitting tool.",
    splitFaq: [
    ...
    pdf2imgSeoTitle: "Convert PDF to JPG Images",
    pdf2imgSeoText: "Turn all pages of your PDF document into high-quality JPG images. Perfect for sharing homework or presentations as pictures.",
    pdf2imgFaq: [
    ...
    organizeSeoTitle: "Reorder and Delete PDF Pages",
    organizeSeoText: "Sort, rearrange, and remove pages from your PDF files easily. Just drag and drop pages into your desired order.",
    organizeFaq: [
    ...
    compressSeoTitle: "Compress PDF File Size",
    compressSeoText: "Reduce the file size of your PDF documents instantly without losing quality. Ideal for email attachments and fast sharing.",
    compressFaq: [
  ...
  ar: {
    ...
    subtitle: "Image to PDF Converter - حوّل صورك إلى ملف PDF نظيف ومنسق بسهولة",
    mergeTitle: "دمج ملفات PDF",
    mergeSubtitle: "ادمج عدة ملفات PDF في ملف واحد بسهولة وأمان",
    splitTitle: "تقسيم وفصل PDF",
    splitSubtitle: "استخرج صفحات محددة من ملف الـ PDF الخاص بك بسرعة",
    pdf2imgTitle: "PDF إلى صور",
    pdf2imgSubtitle: "استخرج جميع صفحات الـ PDF كصور عالية الجودة (JPG) بدون إنترنت",
    organizeTitle: "ترتيب وتنظيم PDF",
    organizeSubtitle: "أعد ترتيب وحذف صفحات ملف الـ PDF الخاص بك بسهولة",
    compressTitle: "ضغط وتصغير PDF",
    compressSubtitle: "قم بتقليل حجم ملف الـ PDF للتمكن من إرساله ومشاركته بسهولة",
    ...
    mergeSeoTitle: "أداة دمج ملفات PDF مجاناً",
    mergeSeoText: "قم بدمج عدة ملفات PDF في مستند واحد بسهولة. أداة دمج الـ PDF الخاصة بنا تعمل بالكامل بدون إنترنت داخل متصفحك، مما يضمن خصوصيتك المطلقة.",
    mergeFaq: [
    ...
    splitSeoTitle: "تقسيم وفصل ملفات PDF بسرعة",
    splitSeoText: "استخرج صفحات معينة أو قم بتجزئة ملف PDF كبير إلى أجزاء أصغر. أداة آمنة وسريعة وتعمل محلياً.",
    splitFaq: [
    ...
    pdf2imgSeoTitle: "تحويل ملفات PDF إلى صور JPG",
    pdf2imgSeoText: "قم بتحويل جميع صفحات ملف الـ PDF إلى صور عالية الجودة بصيغة JPG. مثالية لمشاركة الواجبات أو العروض التقديمية كصور.",
    pdf2imgFaq: [
    ...
    organizeSeoTitle: "إعادة ترتيب وحذف صفحات PDF",
    organizeSeoText: "قم بفرز وتغيير ترتيب صفحات ملفاتك، أو احذف الصفحات غير المرغوب فيها بسهولة تامة عن طريق السحب والإفلات.",
    organizeFaq: [
    ...
    compressSeoTitle: "تصغير وضغط حجم ملف PDF مجاناً",
    compressSeoText: "قم بتقليل حجم ملفات الـ PDF لتسهيل إرسالها عبر الواتساب أو البريد الإلكتروني. عملية ضغط سريعة وآمنة ومجانية بالكامل.",
    compressFaq: [
