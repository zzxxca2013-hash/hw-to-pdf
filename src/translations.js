  ...
  en: {
    ...
    tools: {
      merge: {
        ...
        seoText: "Easily combine multiple PDF files into one single document. Your PDF files are processed locally in your browser and are not uploaded to our servers.",
        faq: [
    ...
    messages: {
      ...
      errorHeicUnsupported: "HEIC photos are not supported in this browser tool. On iPhone, please share or export the photo as JPG/PNG first, then upload it again.",
      ...
      processingInProgress: "Please wait until the current processing finishes before switching tools or leaving this page.",
    },
    ui: {
    ...
    seoText: "Homework to PDF is a free, fast, and secure toolkit designed for students and professionals to convert images to PDF, merge multiple PDF files, and split large PDFs into smaller parts. File processing happens locally in your browser: your images and PDFs are not uploaded to our servers.",
    privacyText: "Your files stay on your device. Image processing, PDF conversion, merging, splitting, organizing, and compression run inside your browser, and we do not upload or store your images or PDF documents on our servers. The site may still connect to external services such as Google Analytics for usage measurement and Google Fonts for typography; these services may receive standard browser/network information and may use cookies or similar technologies according to their own policies.",
    ...
    faq: [
      ...
      { q: "Is this Image to PDF converter safe to use?", a: "Your files are processed locally in your browser and are not uploaded to our servers. The site may still load external services such as analytics or fonts, but your selected files stay on your device." },
  ...
  ar: {
    ...
    tools: {
      merge: {
        ...
        seoText: "قم بدمج عدة ملفات PDF في مستند واحد بسهولة. تتم معالجة ملفات PDF محلياً داخل متصفحك ولا يتم رفعها إلى خوادمنا.",
        faq: [
    ...
    messages: {
      ...
      errorHeicUnsupported: "صور HEIC غير مدعومة في هذه الأداة داخل المتصفح. على iPhone، يرجى مشاركة الصورة أو تصديرها بصيغة JPG/PNG ثم رفعها من جديد.",
      ...
      processingInProgress: "يرجى الانتظار حتى تنتهي المعالجة الحالية قبل تغيير الأداة أو مغادرة الصفحة.",
    },
    ui: {
    ...
    seoText: "منصتنا هي مجموعة أدوات مجانية وسريعة وآمنة صُممت للطلاب والمحترفين لتحويل الصور إلى PDF، بالإضافة إلى دمج ملفات PDF وتقسيم وفصل الصفحات بسهولة. تتم معالجة الملفات محلياً داخل متصفحك: لا يتم رفع صورك أو ملفات PDF إلى خوادمنا.",
    privacyText: "ملفاتك تبقى على جهازك. معالجة الصور، تحويل PDF، الدمج، التقسيم، الترتيب، والضغط تتم داخل متصفحك، ولا نقوم برفع أو تخزين صورك أو ملفات PDF على خوادمنا. مع ذلك قد يتصل الموقع بخدمات خارجية مثل Google Analytics لقياس الاستخدام وGoogle Fonts لعرض الخطوط؛ وقد تستقبل هذه الخدمات معلومات الشبكة/المتصفح المعتادة وقد تستخدم الكوكيز أو تقنيات مشابهة وفق سياساتها.",
    ...
    faq: [
      ...
      { q: "هل تحويل الواجبات ودمج الملفات آمن هنا؟", a: "ملفاتك تتم معالجتها محلياً داخل متصفحك ولا يتم رفع الصور أو ملفات PDF إلى خوادمنا. قد يحمّل الموقع خدمات خارجية مثل التحليلات أو الخطوط، لكن الملفات التي تختارها تبقى على جهازك." },
...
const compatibilityLabels = {
  en: {
    ...
    errorHeicUnsupported: translations.en.messages.errorHeicUnsupported,
  ...
  ar: {
    ...
    errorHeicUnsupported: translations.ar.messages.errorHeicUnsupported,
